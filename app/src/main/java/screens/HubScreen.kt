package id.antasari.p4appnavigation_230104040210.screens
...
import id.antasari.p4appnavigation_230104040210.nav.Route
...
@Composable
private fun MessagesTab(mod: Modifier = Modifier, onOpenDetail: () -> Unit) {
        ...
        Card {
            Column(Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(12.dp)) {
                ListItem(
                    ...
                    supportingContent = { Text("This is a detail screen opened from the Messages tab. It mimics fragment-to-fragment navigation inside one Activity.") }
                )
                ElevatedCard {
            ...
            Column(Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(12.dp)) {
                ElevatedCard {
                    ListItem(
                        ...
                        headlineContent = { Text("HIFZI") },
                        supportingContent = { Text("UI/UX DESAINER") }
                    )
                }
